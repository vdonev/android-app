...
import com.example.vd.mpip_project.model.Comment;
...
public class PostDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private /*ListView*/ LinearLayout mLocationsList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mBodyView = findViewById(R.id.post_body);
        ...
        mLocationsList = findViewById(R.id.list_locations);
    ...
    public void onStart() {
        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                LocationAdapter adapter = new LocationAdapter(getApplicationContext(),post.locations);
                for(int i=0;i < post.locations.size(); i++){
                    View view = adapter.getView(i,null, mLocationsList);
                    mLocationsList.addView(view);
                }
                //mLocationAdapter = new LocationAdapter(getApplicationContext(), post.locations);
    ...
    class LocationAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            if(locations.get(i).image_url != null){
                Glide.with(getApplicationContext())
                        .load(locations.get(i).image_url)
                        .into(imageView);
            }
